        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-0">
          ...
          <div className="flex items-center gap-2 sm:gap-3 lg:gap-4 order-2 sm:order-2 flex-wrap justify-center sm:justify-end">
            ...
            <div className="relative">
              <Button variant="ghost" size="sm" onClick={onNotificationClick} className="text-white hover:bg-white/10 relative p-2 sm:p-2.5">
                <Bell className="h-4 w-4 sm:h-5 sm:w-5" />
                {notifications > 0 && <Badge className="absolute -top-1 -right-1 sm:-top-2 sm:-right-2 h-4 w-4 sm:h-5 sm:w-5 flex items-center justify-center p-0 bg-red-500 text-white text-xs min-w-0">
            ...
            {userRole === 'admin' && onRoleSwitch && <Button variant="outline" size="sm" onClick={onRoleSwitch} className="border-white/30 hover:bg-white/10 hover:border-white/50 transition-all duration-200 text-xs sm:text-sm px-2 sm:px-3 text-inherit">
            ...
            {/* Logout Button */}
            <Button variant="outline" size="sm" onClick={onLogout} className="border-white/30 hover:border-white/50 transition-all duration-200 text-xs sm:text-sm px-2 sm:px-3 bg-inherit text-red-900">
